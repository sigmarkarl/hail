...
following command builds Hail for Scala 2.12.10 and Spark 3.0.0-preview2,
installs the Python library, and installs all the Python
dependencies::

    make install-on-cluster HAIL_COMPILE_NATIVES=1 SCALA_VERSION=2.12.10 SPARK_VERSION=3.0.0-preview2
